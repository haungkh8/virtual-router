...
class Router():
    def __init__(self, tractorAddr='127.0.0.1', tractorPort=5555, peerPort=6666, MaxConnect=10):
        """
            ...
            # Peer: WANT ON MESSIZE MSG（filenames)
            # Tractor: ON OK
        """
        #获取本地目录
        print("hello")
        ...
        #接收回复
        header = getHeader(self.Tsock).rstrip()
        if header == 'ON OK':
            print(header)
        else:
    ...
    def getFile(self, fileName):
        """
            ...
            cotroller->peer:GET OK msgSize msg(IPs)
        """
